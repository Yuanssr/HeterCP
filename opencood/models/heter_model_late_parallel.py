...
class HeterModelLateParallel(nn.Module):
    def __init__(self, args):
        super(HeterModelLateParallel, self).__init__()
    ...
    def forward(self, data_dict):
        ...
        for modality_name in self.modality_name_list:
            ...
            all_preds_dict = {'cls_preds': cls_preds,
                            'reg_preds': reg_preds,
                            'dir_preds': dir_preds}
            
            output_dict.update({modality_name: all_preds_dict})
