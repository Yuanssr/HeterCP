...
from opencood.data_utils.datasets.later_intermediate_heter_fusion_dataset import getLateintermediateheterFusionDataset
from opencood.data_utils.datasets.late_heter_parallel_fusion_dataset import getLateheterparallelFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['late', 'lateheter', 'lateheterparallel', 'lateintermediateheter', 'intermediate', 'intermediate2stage', 'intermediateheter', 'early', 'intermediateheterv2xreal',
