...
LOG_DIR=opencood/logs/Baselines/stage2/Backalign/V2XREAL_m5_OPV2V_m1_v2xvit
ERR_LOG="$LOG_DIR/train.err"
OUT_LOG="$LOG_DIR/train.log"
mkdir -p "$LOG_DIR"

#train
CUDA_VISIBLE_DEVICES=5,6 PYTHONUNBUFFERED=1 \
...
#inference
CUDA_VISIBLE_DEVICES=5 python opencood/tools/inference_v2xreal.py --model_dir "$LOG_DIR" --visualize_feature
